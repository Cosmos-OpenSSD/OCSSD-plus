...
#define OCSSD_METADATA_READ_ADDR		(OCSSD_METADATA_WRITE_ADDR + OCSSD_METADATA_WRITE_SIZE)//512KBB = 4KB * 128 OCSSD commands
#define OCSSD_METADATA_READ_SIZE		524288
...
#define STORAGE_CAPACITY_L				NUMBER_OF_SECTORS_ON_DEVICE//(8*8*2*4096*128*4) * 4KB = 1TB//not used
...
#define NUMBER_OF_CHANNELS_ON_DEVICE	8
#define NUMBER_OF_LUNS_ON_DEVICE		64
#define NUMBER_OF_PLANES_ON_DEVICE		128
#define NUMBER_OF_BLOCKS_ON_DEVICE		524288
#define NUMBER_OF_PAGES_ON_DEVICE		67108864
#define NUMBER_OF_SECTORS_ON_DEVICE		268435456
