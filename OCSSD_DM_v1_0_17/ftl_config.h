...
#define	BYTES_PER_SPARE_REGION_OF_SLICE		4096		//first 248 bytes is valid, other bytes dummy, for 4KB alignment (data transfer unit size of nvme DMA engine is 4KB)
...
#define MB_PER_MIN_FREE_BLOCK_SPACE			(USER_DIE * MB_PER_BLOCK)
#define MB_PER_METADATA_BLOCK_SPACE			(USED_DIE * MB_PER_BLOCK)
#define MB_PER_OVER_PROVISION_BLOCK_SPACE	((USED_BLOCK_PER_SSD / 20) * MB_PER_BLOCK)
